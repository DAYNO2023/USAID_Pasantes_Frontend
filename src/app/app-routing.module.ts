...
const routes: Routes = [
    ...
    },
    {
        ...
        children: [
            ...
            { path: 'acceso', data: { breadcrumb: 'Acceso' , canActivate: [PermissionsGuard] }, loadChildren: () => import('./demo/components/componentacceso/acceso.module').then(m => m.AccesoModule) }
